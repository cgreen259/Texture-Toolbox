...
!f2py depend(max_val, max_val) glcm
	...
	!					glcm(val1, val2) = glcm(val1, val2) + 1
						glcm(val1, val2) = glcm(val1, val2) + sqrt(abs(real(i2-i))+abs(real(j2-j)))
					end if
				end if
			end do
		end do	
...
!	Calculate GLCM of 3D array
	...
	integer :: val1, val2, i, j, k, i2, j2, k2
	real :: glcm(0:max_val,0:max_val), idiff, jdiff, kdiff
							...
							do i2=i-1, i+1
								if (k2 .NE. k .OR. j2 .NE. j .OR. i2 .NE. i) then
									...
									if (val2 >= min_val) then
										idiff = abs(i2-i)
										!glcm(val1, val2) = glcm(val1, val2) + 1
										glcm(val1, val2) = glcm(val1, val2) + sqrt(real(idiff+jdiff+kdiff))
									end if
								end if
							end do
						end do
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	SUBROUTINE glcm3d_test(image, glcm, max_val, min_val, sizex, sizey, sizez)
